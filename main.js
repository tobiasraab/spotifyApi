...
// Get from spotify developer site:
...
app.get('/currentsong', (req, res) => {
  ...
  // use the access token to access the Spotify Web API
  request.get(options, function (error, response, body) {
    console.log('CURRENT_SONG: ', body.item.name);
...
app.post('/setvolume', jsonParser, (req, res) => {
  ...
  // use the access token to access the Spotify Web API
  request.put(options, function (error, response, body) {
    console.log('CHANGE_VOLUME: ', req.body.volume_percent);
    console.log(response.body)
    if(error){
      console.log('ERROR_VOLUME: ', error)
    }
